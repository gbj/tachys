...
impl ToTokens for Model {
    fn to_tokens(&self, tokens: &mut TokenStream) {
            ...
            (
                quote! {
                    ...
                    #[cfg_attr(
                        ...
                        ::tachys::tracing::instrument(level = "info", name = #trace_name, skip_all)
                    )]
                },
                quote! {
                    let span = ::tachys::tracing::Span::current();
                },
                quote! {
                ...
                if no_props {
                    ...
                    quote! {
                        ::tachys::tracing_props![#prop_names];
                    }
                },
            )
        } else {
        ...
        let output = quote! {
            ...
            #[derive(::tachys::typed_builder_macro::TypedBuilder #props_derive_serialize)]
            //#[builder(doc)]
            ...
            impl #impl_generics ::tachys::component::Props for #props_name #generics #where_clause {
